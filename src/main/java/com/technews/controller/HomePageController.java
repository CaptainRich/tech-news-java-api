...
// The 'Controller' annotation indicates that these controllers will control flow
// for the front-end user experience.
@Controller
public class HomePageController {

    // 'Autowired" informs Spring to scan for objects that need to be instantiated for
    // a class or method to run.
    @Autowired
    ...
    // This is the login endpoint, it calls login.html when the /login route is hit.
    @GetMapping("/login")
    public String login(Model model, HttpServletRequest request) {
        ...
        model.addAttribute("user", new User());         // send info to Thymeleaf templates
        return "login";
    }
    ...
    public String logout(HttpServletRequest request) {
        if (request.getSession(false) != null) {    // if the session exists, log it out
    ...
    public String homepageSetup(Model model, HttpServletRequest request) {
        ...
        // Get all of the posts for this user.
        for (Post p : postList) {
