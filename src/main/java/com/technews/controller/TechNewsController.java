...
public class TechNewsController {
    ...
    public String login(@ModelAttribute User user, Model model, HttpServletRequest request) throws Exception {
        ...
        // Verify all data fields are properly filled in
    ...
    // This route allows users to create a new profile
    @PostMapping("/users")
    ...
    // This route allows users to add a post
    @PostMapping("/posts")
    ...
    // This route gets a specific post by ID
    ...
    // This route lets users comment on posts.
    ...
    public String createCommentCommentsPage(@ModelAttribute Comment comment, Model model, HttpServletRequest request) {
        ...
        if (comment.getCommentText().isEmpty() || comment.getCommentText().equals(null)) {
            // Make sure the comment field has something in it.
    ...
    // This route allows the editing of comments.
    ...
    // This route allows users to vote for a post
