...
// See 'User.java' for important comments as the the structure and use of the code below.
...
public class Post implements Serializable {
    ...
    @NotNull                               // can't be null in the database
    @Temporal(TemporalType.DATE)           // allows the use of the type 'Date' in the database
    @Column(name = "posted_at")            // the name of the column in the database
